...
describe "projects/imports/new.html.haml" do
  ...
  context 'when import fails' do
    let(:project) { create(:project_empty_repo, import_status: :failed, import_type: :gitlab_project, import_source: '/var/opt/gitlab/gitlab-rails/shared/tmp/project_exports/uploads/t.tar.gz', import_url: nil) }
