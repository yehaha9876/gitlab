module MigrationsHelpers
  ...
  def table_exists?(name)
    application_record.connection.table_exists?(name)
  end
  ...
  def clear_schema_cache!
    application_record.connection_pool.connections.each do |conn|
  ...
  def reset_column_in_all_models
    ...
    application_record.descendants.each(&method(:reset_column_information))
