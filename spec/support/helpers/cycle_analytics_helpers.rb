module CycleAnalyticsHelpers
  ...
  def create_commit(message, project, user, branch_name, count: 1, commit_time: nil)
  ...
  def create_merge_request_closing_issue(user, project, issue, message: nil, source_branch: nil, commit_message: 'commit message')
    ...
    create_commit('content', project, user, source_branch, commit_time: Time.now + 1.second)
