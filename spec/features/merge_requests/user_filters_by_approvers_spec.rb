...
describe 'Merge Requests > User filters by approvers', :js do
  ...
  let!(:second_merge_request_with_approver) do
    create(:merge_request_with_approver, title: 'Bugfix2', source_project: project, target_project: project, source_branch: 'bugfix2')
  end
