  ...
  describe '#predefined_variables_for_project' do
    ...
    shared_examples 'setting variables' do
      it 'sets the variables' do
        expect(subject.predefined_variables_for_project(project: project)).to include(
    ...
    context 'no namespace provided' do
      ...
      it 'sets the KUBE_NAMESPACE' do
        kube_namespace = subject.predefined_variables_for_project(project: project).find { |h| h[:key] == 'KUBE_NAMESPACE' }
