...
describe Ci::Pipeline, models: true do
  ...
  describe '.latest_successful_for_multiple' do
    include_context 'with some outdated pipelines'
    ...
    it 'returns the latest successful pipeline for both refs' do
      ...
      expect(described_class.latest_successful_for_multiple(refs)).to eq({ 'ref1' => latest_successful_pipeline1, 'ref2' => latest_successful_pipeline2 })
    end
  end
