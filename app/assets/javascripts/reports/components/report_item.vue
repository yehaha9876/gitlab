...
<template>
  <li :class="{ 'is-dismissed': issue.isDismissed }" class="report-block-list-issue">
    <issue-status-icon v-if="!issue.isDismissed" :status="status" class="append-right-5" />
    <span class="prepend-top-5 prepend-left-8 append-right-8" v-else>DISMISSED</span>
