...
Settings.cron_jobs['geo_repository_sync_dispatch_worker'] ||= Settingslogic.new({})
Settings.cron_jobs['geo_repository_sync_dispatch_worker']['cron'] ||= '*/1 * * * *'
Settings.cron_jobs['geo_repository_sync_dispatch_worker']['job_class'] ||= 'Geo::RepositorySyncDispatchWorker'
Settings.cron_jobs['geo_wiki_sync_dispatch_worker'] ||= Settingslogic.new({})
Settings.cron_jobs['geo_wiki_sync_dispatch_worker']['cron'] ||= '*/1 * * * *'
Settings.cron_jobs['geo_wiki_sync_dispatch_worker']['job_class'] ||= 'Geo::WikiSyncDispatchWorker'
