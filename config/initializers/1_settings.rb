...
Settings.cron_jobs['geo_repository_verification_worker'] ||= Settingslogic.new({})
Settings.cron_jobs['geo_repository_verification_worker']['cron'] ||= '0 0 * * *'
Settings.cron_jobs['geo_repository_verification_worker']['job_class'] ||= 'Geo::RepositoryVerificationWorker'
