...
Settings.cron_jobs['geo_metrics_updater'] ||= Settingslogic.new({})
Settings.cron_jobs['geo_metrics_updater']['cron'] ||= '*/1 * * * *'
Settings.cron_jobs['geo_metrics_updater']['job_class'] ||= 'Geo::MetricsUpdateWorker'
