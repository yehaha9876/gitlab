...
Settings.cron_jobs['geo_schedule_backfill_worker'] ||= Settingslogic.new({})
Settings.cron_jobs['geo_schedule_backfill_worker']['cron'] ||= '10 0,8,16 * * *'
Settings.cron_jobs['geo_schedule_backfill_worker']['job_class'] ||= 'GeoScheduleBackfillWorker'
