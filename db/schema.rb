...
ActiveRecord::Schema.define(version: 20180920043317) do
  ...
  create_table "geo_event_log", id: :bigserial, force: :cascade do |t|
    ...
    t.index ["repositories_changed_event_id"], name: "index_geo_event_log_on_repositories_changed_event_id", using: :btree
    t.index ["repository_created_event_id"], name: "index_geo_event_log_on_repository_created_event_id", using: :btree
    t.index ["repository_deleted_event_id"], name: "index_geo_event_log_on_repository_deleted_event_id", using: :btree
    t.index ["repository_renamed_event_id"], name: "index_geo_event_log_on_repository_renamed_event_id", using: :btree
    t.index ["repository_updated_event_id"], name: "index_geo_event_log_on_repository_updated_event_id", using: :btree
    t.index ["reset_checksum_event_id"], name: "index_geo_event_log_on_reset_checksum_event_id", using: :btree
  end
  ...
  create_table "vulnerability_occurrences", id: :bigserial, force: :cascade do |t|
    ...
    t.index ["pipeline_id"], name: "index_vulnerability_occurrences_on_pipeline_id", using: :btree
    t.index ["project_id", "ref", "scanner_id", "primary_identifier_fingerprint", "location_fingerprint"], name: "index_vulnerability_occurrences_on_unique_keys", unique: true, using: :btree
