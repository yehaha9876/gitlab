...
ActiveRecord::Schema.define(version: 20180220012057) do
  ...
  add_index "project_repository_states", ["project_id"], name: "index_project_repository_states_on_project_id", using: :btree
  ...
  add_foreign_key "project_repository_states", "projects"
