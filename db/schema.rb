...
ActiveRecord::Schema.define(version: 20171006121407) do
  ...
  add_index "projects", ["mirror", "mirror_last_update_at"], name: "index_projects_on_mirror_and_mirror_last_update_at", where: "mirror", using: :btree
