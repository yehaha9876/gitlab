...
ActiveRecord::Schema.define(version: 20180912113336) do
  ...
  add_index "prometheus_alerts", ["project_id", "prometheus_metric_id", "environment_id"], name: "index_prometheus_alerts_metric_environment", unique: true, using: :btree
