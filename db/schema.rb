...
ActiveRecord::Schema.define(version: 20180216165932) do
  ...
  add_index "lfs_objects", ["lock_id"], name: "index_lfs_objects_on_lock_id", unique: true, using: :btree
  add_index "lfs_objects", ["locked_by_id"], name: "index_lfs_objects_on_locked_by_id", using: :btree
  ...
  add_foreign_key "lfs_objects", "users", column: "locked_by_id", on_delete: :nullify
