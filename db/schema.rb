...
ActiveRecord::Schema.define(version: 20180704113504) do
  ...
  add_index "project_repository_states", ["project_id"], name: "idx_repository_states_repository_outdated_checksums_partial", where: "((repository_verification_checksum IS NOT NULL) AND (last_repository_verification_failure IS NULL))", using: :btree
  add_index "project_repository_states", ["project_id"], name: "idx_repository_states_wiki_outdated_checksums_partial", where: "((wiki_verification_checksum IS NOT NULL) AND (last_wiki_verification_failure IS NULL))", using: :btree
