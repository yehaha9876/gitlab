...
following the [Using Docker Build](/ee/ci/docker/using_docker_build.md)
and [Using the GitLab Container Registry documentation](/ee/ci/docker/using_docker_build.md#using-the-gitlab-container-registry).
