...
- From [group issue boards](issue_board.md#group-issue-boards) (available in [GitLab Premium]), you can filter by only group labels in the [search and filter bar](../search/index.md#issue-boards).
- From [project boards](issue_board.md), you can filter by both group labels and project labels in the [issue board configuration](issue_board.md#board-with-configuration) (available in [GitLab Starter]).
- From [group issue boards](issue_board.md#group-issue-boards) (available in [GitLab Premium]), you can filter by only group labels in the [issue board configuration](issue_board.md#board-with-configuration) (available in [GitLab Starter]).
