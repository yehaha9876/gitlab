...
>**Note:**
- [Issue board configuration](issue_board.md#board-with-configuration) is available in GitLab Starter.
- [Group issue boards](issue_board.md#group-issue-boards) are available in GitLab Premium.
