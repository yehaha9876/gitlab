...
- `POSTGRESQL_PASSWORD_HASH`. This is a hash generated out of PostgreSQL username/password pair.
Can be generated by running:
...
1. Ensure the node is talking to the current master:
     ...
     needed to generate an MD5 password hash for the `pgbouncer` user. Using the
     `sudo gitlab-ctl pg-password-md5 PGBOUNCER_USERNAME` will do this for you automatically.
