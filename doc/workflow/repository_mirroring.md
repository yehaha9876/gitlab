...
> [Introduced][ee-2551] in GitLab Enterprise Edition 9.15
...
from the authentication methods dropdown. On doing so, the method is updated
**immediately**. GitLab will generate a 4096-bit RSA key and display the public
component of that key to you:
...
If you need to change this key at any time, you can press the `Regenerate key`
button to do so. Note that you'll have to update the source repository to take
account of the change if you do this.
