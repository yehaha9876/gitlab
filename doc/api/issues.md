...
| `assignee_ids`  | Array[integer] | no  | The ID of the users to assign the issue to. Set to `nil` to unassign all assignees.                     |
| `milestone_id` | integer | no       | The ID of a milestone to assign the issue to. Set to `nil` to unassign a milestone.                        |
| `labels`       | string  | no       | Comma-separated label names for an issue. Set to `nil` to unassign all labels.                             |
