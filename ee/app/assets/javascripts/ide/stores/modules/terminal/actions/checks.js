...
export const fetchConfigCheck = ({ dispatch, rootState, rootGetters }) => {
  ...
  axios
    .post(`/${currentProject.path_with_namespace}/ide/terminals/check_config`, { branch: currentBranchId, format: 'json' })
    .then(() => {
...
export const fetchRunnersCheck = ({ dispatch, rootGetters }, options = {}) => {
  ...
  axios
    .get(`/api/v4/projects/${currentProject.id}/runners`, { params: { scope: 'active', tag_list: WEB_IDE_JOB_TAG } })
    .then(({ data }) => {
