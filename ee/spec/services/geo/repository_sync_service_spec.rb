  ...
  describe '#execute' do
    ...
    it 'fetches project repository with JWT credentials' do
      ...
      expect(repository).to receive(:fetch_as_mirror)
        .with(url_to_repo, remote_name: 'geo', forced: true, prune: true)
        .once
    ...
    context 'retries' do
      ...
      it 'tries to redownload repo' do
        ...
        expect(repository).to receive(:fetch_as_mirror).with(url_to_repo, remote_name: 'geo', forced: true, prune: false)
